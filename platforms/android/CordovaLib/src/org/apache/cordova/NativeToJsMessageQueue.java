        ...
        static int calculateEncodedLengthHelper(PluginResult pluginResult) {
            switch (pluginResult.getMessageType()) {
                ...
                case PluginResult.MESSAGE_TYPE_NUMBER: // n
                    String numMsg = pluginResult.getMessage();
                    return 1 + (numMsg != null ? numMsg.length() : 0);
                case PluginResult.MESSAGE_TYPE_STRING: // s
                    String strMsg = pluginResult.getStrMessage();
                    return 1 + (strMsg != null ? strMsg.length() : 0);
                ...
                default:
                    String jsonMsg = pluginResult.getMessage();
                    return jsonMsg != null ? jsonMsg.length() : 0;
            }
        }
